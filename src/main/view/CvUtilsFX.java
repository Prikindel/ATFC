...
public class CvUtilsFX {
    ...
    public static Scene getSceneImage(Mat img, Double width, Double height) {
        ...
        if (im != null) {
            ...
            if (im.getWidth() < 1000) {
                ...
                sp.setPrefWidth(1000.0);
            if (im.getHeight() < 700) {
                sp.setPrefHeight(im.getHeight() + 5);
            } else
                sp.setPrefHeight(700.0);
        }
        sp.setContent(iv);
        sp.setPannable(true);
    ...
    public static Scene getSceneImage(Mat img) {
        return getSceneImage(img, 0.0, 0.0);
    }

    public static void showImageInNewWindow(Scene scene, String title) {
